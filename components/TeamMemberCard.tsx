  ...
  return (
    <div className="group relative rounded-lg overflow-hidden bg-gray-900 shadow-lg">
      ...
      <div className="aspect-[3/4] relative overflow-hidden">
        ...
        <div 
          className="absolute left-1/2 top-1/2 w-[200%] h-0 -translate-x-1/2 -translate-y-1/2 -rotate-45 
                     bg-white/20 z-[1] transition-all duration-[1500ms] ease-linear
                     group-hover:h-[250%] group-hover:bg-white/10"
          aria-hidden="true"
        ></div>
      ...
      <div className="p-4 bg-white">
        <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-blue-500">{member.name}</h3>
